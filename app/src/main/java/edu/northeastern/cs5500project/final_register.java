...
public class final_register extends AppCompatActivity {
    ...
    Boolean validateForm(String emails, String passwords, String firstNames, String lastNames, String userNames, String phoneNumbers, String weights, String heights) {
        Boolean flag = true;
